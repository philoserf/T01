...
var MononoteSettingsTab = class extends import_obsidian.PluginSettingTab {
  constructor(app, plugin) {
    super(app, plugin);
    this.delayOptions = [100, 150, 200, 300, 500];
    this.plugin = plugin;
  }
  display() {
    ...
    const delayOptionsRecord = this.delayOptions.reduce((acc, current) => {
...
var Mononote = class extends import_obsidian2.Plugin {
  ...
  async processActiveLeaf(activeLeaf) {
    ...
    logMsg("Processing leaf", {
      file: activeLeaf.view.getState().file,
      parent: activeLeaf.parent.id,
    });
    ...
    return new Promise((resolve) => {
      const { workspace } = this.app;
      const viewType =
        activeLeaf == null ? void 0 : activeLeaf.view.getViewType();
      const duplicateLeaves = workspace
        ...
        .filter((l) => {
          ...
          return (
            ...
            l.id !== leafID &&
            ((_a = l.view) == null ? void 0 : _a.getState().file) === filePath
          );
        })
        .sort((l1, l2) => {
