  ...
  "node_modules/before-after-hook/index.js"(exports, module2) {
    ...
    function bindApi(hook2, state, name) {
      ...
      ["before", "error", "after", "wrap"].forEach(function (kind) {
        ...
        hook2[kind] = hook2.api[kind] = bindable(addHook, null).apply(
          null,
          args,
        );
      });
  ...
  "node_modules/@sindresorhus/slugify/index.js"(exports, module2) {
    ...
    var counter = () => {
      ...
      const countable = (string, options) => {
        ...
        occurrences.set(
          stringLower,
          typeof counter2 === "number" ? counter2 + 1 : 1,
        );
...
var fromUint8Array = (u8a, urlsafe = false) =>
...
var Octokit = class {
  constructor(options = {}) {
    ...
    if (!options.authStrategy) {
      ...
      const _a = options,
        { authStrategy } = _a,
        otherOptions = __objRest(_a, ["authStrategy"]);
...
var Publisher = class {
  ...
  uploadToGithub(path, content) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        if (
          response.status === 200 &&
          (fileData == null ? void 0 : fileData.type) === "file"
        ) {
  ...
  prepareAssociatedAssets(text, filePath) {
    return __async(this, null, function* () {
      ...
      const imagePathsToTFilesMap = yield this.extractEmbeddedImageFiles(
        text,
        filePath,
      );
  ...
  extractEmbeddedImageFiles(text, filePath) {
    return __async(this, null, function* () {
      ...
      const embeddedImageRegex =
        /!\[\[(.*?\.(png|webp|jpg|jpeg|gif|bmp|svg))(?:\|(.*?))?\]\]/g;
...
var PublishStatusManager = class {
  ...
  getPublishStatus() {
    return __async(this, null, function* () {
      ...
      const { notes, assets } =
        yield this.publisher.getFilesMarkedForPublishing();
      ...
      const deletedNotePaths = this.getDeletedPaths(
        Object.keys(remoteNoteHashes),
        notes.map((f) => f.path),
      );
      const deletedImagePaths = this.getDeletedPaths(
        Object.keys(remoteImageHashes),
        assets,
      );
...
var PublishStatusModal = class {
  ...
  initialize() {
    return __async(this, null, function* () {
      ...
      const headerEl = this.modal.contentEl.createEl("div", {
        cls: "publish-header",
      });
      ...
      const headerText = headerLeft.createEl("p", {
        cls: "publish-header-text",
      });
      ...
      const syncIcon = iconsContainer.createEl("div", {
        cls: "clickable-icon",
      });
      ...
      const settingsIcon = iconsContainer.createEl("div", {
        cls: "clickable-icon",
      });
      ...
      settingsIcon.addEventListener("click", () => {
        ...
        (_b = this.app.setting) == null
          ? void 0
          : _b.openTabById("obsidian-flowershow");
      });
      ...
      [this.publishedCounter, this.publishedList] = this.createSection(
        "Published",
        null,
        null,
      );
      [this.changedCounter, this.changedList] = this.createSection(
        "Changed",
        "Update notes",
        () =>
          __async(this, null, function* () {
      ...
      [this.unpublishedCounter, this.unpublishedList] = this.createSection(
        "Unpublished",
        "Publish notes",
        () =>
          __async(this, null, function* () {
      ...
      [this.deletedCounter, this.deletedList] = this.createSection(
        "Deleted",
        "Delete notes from site",
        () =>
          __async(this, null, function* () {
  ...
  createSection(title, buttonText, buttonCallback) {
    ...
    if (buttonText && buttonCallback) {
      const button = new import_obsidian3.ButtonComponent(headerContainer)
...
var SiteManager = class {
  ...
  getNoteHashes() {
    return __async(this, null, function* () {
      const octokit = new Octokit({ auth: this.settings.githubToken });
      const response = yield octokit.request(
        `GET /repos/{owner}/{repo}/git/trees/{tree_sha}?recursive=${Math.ceil(Math.random() * 1e3)}`,
        {
          owner: this.settings.githubUserName,
          repo: this.settings.githubRepo,
          tree_sha: "HEAD",
...
var SettingView = class {
  constructor(app, settingsRootElement, settings, saveSettings) {
    this.debouncedSaveAndUpdate = (0, import_obsidian4.debounce)(
  ...
  initialize(prModal) {
    return __async(this, null, function* () {
      ...
      this.settingsRootElement
        .createEl("h3", { text: "GitHub Authentication" })
        .prepend((0, import_obsidian4.getIcon)("github"));
  ...
  initializeGitHubRepoSetting() {
    new import_obsidian4.Setting(this.settingsRootElement)
...
var Flowershow = class extends import_obsidian5.Plugin {
  onload() {
    return __async(this, null, function* () {
      ...
      this.publishStatusManager = new PublishStatusManager(
        this.siteManager,
        this.publisher,
      );
      ...
      this.addRibbonIcon("flowershow-icon", "Publish with Flowershow", () =>
        __async(this, null, function* () {
  ...
  publishSingleNote() {
    return __async(this, null, function* () {
      try {
        ...
        new import_obsidian5.Notice(
          `\u2705 Successfully published note to your Flowershow site.`,
        );
      } catch (e) {
        console.error(e);
        new import_obsidian5.Notice(
  ...
  publishAllNotes() {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const { unpublishedNotes, changedNotes, deletedNotePaths } =
          yield this.publishStatusManager.getPublishStatus();
        const notesToPublish = changedNotes.concat(unpublishedNotes);
        const notesToDelete = deletedNotePaths;
        const filesRequiringActionCount =
          notesToPublish.length + notesToDelete.length;
        const statusBar = new PublishStatusBar(
          statusBarItem,
          filesRequiringActionCount,
        );
        new import_obsidian5.Notice(
          `Publishing ${notesToPublish.length} notes and deleting ${notesToDelete.length} notes.`,
          8e3,
        );
        for (const file of notesToPublish) {
          try {
            ...
            new import_obsidian5.Notice(
              `Unable to publish note ${file.path}, skipping it.`,
            );
          }
        }
        for (const path of notesToDelete) {
          try {
            ...
            new import_obsidian5.Notice(
              `Unable to delete note ${path}, skipping it.`,
            );
          }
        }
